...
![The first steps of a run](assets/04-progress--early.png)
...
| **"पोस्टरचा मजकूर तयार करत आहोत…"** | *(poster runs)* Writing the poster text |
| **"पोस्टरचे चित्र तयार करत आहोत…"** | *(poster runs)* Painting the poster image |
| **"पोस्टर जुळवत आहोत…"** | *(poster runs)* Assembling the final poster |

![Mid-run — the article is being written](assets/04-progress--mid.png)

A full run typically takes **several minutes**. As the page itself says: **"यास काही मिनिटे लागू शकतात. हे पान उघडे ठेवा किंवा नंतर परत या."** (*This can take a few minutes. Keep this page open, or come back later.*)
...
![Article ready, poster still rendering](assets/04-results--article-poster-skeleton.png)
...
![The 5W1H summary card](assets/04-results--5w1h.png)

## The finished article ("तयार झालेला लेख")

![The finished article with its actions](assets/04-results--article.png)
...
![The fact-check fold opened](assets/04-results--factcheck.png)
...
![The article being translated](assets/04-results--article-translating.png)
...
![The article in English after translating](assets/04-results--article-english.png)

## The finished poster ("तयार झालेले पोस्टर")

![The poster panel](assets/04-results--poster-panel.png)
