...
export {
  ...
  NEW_VIDEO_CHARACTERS_TABLE,
  NEW_VIDEO_CONVERSATION_CHARACTERS_TABLE,
  ...
  type NewVideoCharacterDbPatch,
  type NewNewVideoCharacter,
} from './new-video.js';
export {
  USAGE_EVENTS_TABLE,
  recordUsageEvent,
